...
///*	
	public static void invertSVD(SimpleMatrix A)
	{
		...
		//Condition number
		double cond = svd.cond(); // low cond nmb = Matrix is well conditioned => little change in input gives large change in output; high cond nmb = ill cond
	...
	public static void optimizationProblem2(SimpleMatrix b)
	{
		...
		int lastCol = svd.getV().getCols() - 1; // because we start counting from zero :-o
	...
	public static void main(String[] args) {
		...
		String filename = "/proj/i5dmip/of20ecal/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/yu_fill.jpg";
		...
		String filenameShepp = "/proj/i5dmip/of20ecal/Shepp-Logan Phantom.tif";
