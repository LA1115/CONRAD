...
public class DefectPixelInterpolation {
	...
	public Grid2D interpolateSpectral(Grid2D image, Grid2D mask, int maxIter, boolean zeroPadding)
	{
		...
		for(int i = 0; i < maxIter; i++)
		{
			...
			//mirror the positions at halfDim ( we don't actually need this)
				...
				(s1 == halfDim[0] && t1 == halfDim[1]))
			{
				...
				//TODO
				//TODO
				Complex FHatNextVal = new Complex(FHatNext.getRealAtIndex(s1, t1), FHatNext.getImagAtIndex(s1, s2));
				Complex GVal = new Complex(G.getRealAtIndex(s1, t1), G.getImagAtIndex(s1, s2));
				Complex WVal = new Complex(W.getRealAtIndex(s1, t1), W.getImagAtIndex(s1, s2));
	...
	public static void main(String[] args) {
		...
		String filename = "/proj/i5dmip/of20ecal/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/testimg.bmp";
		String filenameMask = "/proj/i5dmip/of20ecal/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mask.bmp";
