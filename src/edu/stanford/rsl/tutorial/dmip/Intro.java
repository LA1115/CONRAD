...
public class Intro {
	...
	public static void gridIntro(){
		...
		//Display image
		//TODO
		image.show("Horst der Kreis");
		
		//Copy an image
		//TODO
		Grid2D copy = new Grid2D(image);
		copy.show("Kreis der Horst, copy of Horst der Kreis");
		
		
		//Load an image from file
		//String filename = "/CONRAD/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mr12.dcm";
		String filename = "/proj/i5dmip/of20ecal/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mr12.dcm";
		...
		//TODO
		String outFilename ="/proj/i5dmip/of20ecal/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mr12out.tif";
		// there is something not checked in :( 
